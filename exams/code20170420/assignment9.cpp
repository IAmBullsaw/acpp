...
//
//
// This code is directly copied from http://www.ida.liu.se/~TDDD38/exam/old_exams/170420/program9.cc
//
// Somewhere along the road in answering this question, everything broke and thus I'm pushing this
// I realize now that the reason for things not working properly, is that clang++4.0 -std=c++1z will not compile this
// Hopefully I will answer this question once more and push the new version instead.
//
//
//
//
